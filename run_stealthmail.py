...
if __name__ == '__main__':
    print("Welcome to StealthMail"
          "\nEmpowering journalists, whistleblowers and secret agents"
          "\nBuilt by: team StealthMail"
          "\nOur Github: "
          "\nLoved the project? Please buy us a coffee.")
                ...
                try:
                    ...
                    if "Error in generate_keys" in str(e):
                        print("An error occurred. "
                              "Make sure you have entered a correct private key generated by StealthMail.")
